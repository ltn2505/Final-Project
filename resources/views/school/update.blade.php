                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="school_name" type="text"
                                        ...
                                        value="{{ $school->school_name }}" required autocomplete="school_name" autofocus>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="headmaster" type="text"
                                        ...
                                        value="{{ $school->headmaster }}" autocomplete="headmaster" autofocus>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <select class="form-select" name="gender">
                                        ...
                                        <option value="Male" {{ $school->gender == 'Male' ? 'selected' : '' }}>Male
                                        </option>
                                        <option value="Female" {{ $school->gender == 'Female' ? 'selected' : '' }}>Female
                                        </option>
                                    </select>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="phone_number" type="text"
                                        ...
                                        value="{{ $school->phone_number }}" autocomplete="phone_number" autofocus>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="email" type="email"
                                        ...
                                        value="{{ $school->email }}" autocomplete="email">
