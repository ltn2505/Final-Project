        ...
        <div id="header-carousel" class="carousel slide carousel-fade" data-bs-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img class="w-100" src="{{ asset('img/gw4.jpg') }}" alt="Image">
                ...
                <div class="carousel-item">
                    <img class="w-100" src="{{ asset('img/gw5.jpg') }}" alt="Image">
                    <div class="carousel-caption">
                        <div class="container">
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="row g-5">
                ...
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.5s" id="register">
                    ...
                    <form method="POST" action="{{ route('online.store') }}">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-sm-6">
                                <div class="form-floating">
                                    <select name="gender" class="form-select" id="service">
                            ...
                            <div class="col-sm-6">
                                <div class="form-floating">
                                    <input naeme="mobile" type="text" class="form-control" id="mobile"
                            ...
                            <div class="col-sm-6">
                                <div class="form-floating">
                                    <select name="specialized_register" class="form-select" id="service">
                                        <option selected>Major</option>
                                        <option value="IT">Information Technology</option>
                                        <option value="GD">Graphic Design</option>
                                        <option value="AI">Artificial intelligence</option>
                                        <option value="IB">International Bussiness</option>
